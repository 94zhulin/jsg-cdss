...
import com.jsg.utils.redis.FastJson2JsonRedisSerializer;
import com.jsg.utils.redis.RedisTemplate;
...
public class RedisConfig {
    ...
    public RedisService redisUtil(RedisTemplate redisTemplate) {
        log.info("RedisService注入成功！");
