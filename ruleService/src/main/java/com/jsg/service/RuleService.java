...
public interface RuleService {
    ...
    ResultBase ruleHistory(String ids, String policyType, Pageable pageable);
    ...
    ResultBase ruleDeployment(Integer ruleId, Integer deploy_status, Integer policy_type);
