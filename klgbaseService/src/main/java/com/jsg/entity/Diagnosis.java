...
public class Diagnosis {
    ...
    @ApiModelProperty(position = 5, value = "    传染病标志：1-是；0-否", required = true)
    private String crbFlag;
    @ApiModelProperty(position = 5, value = "    产妇分娩标志：1-是；0-否", required = true)
    private String cffmFlag;
    @ApiModelProperty(position = 5, value = "    单病种标志：1-是；0-否", required = true)
